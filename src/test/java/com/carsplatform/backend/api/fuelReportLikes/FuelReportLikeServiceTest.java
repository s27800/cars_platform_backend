...
class FuelReportLikeServiceTest {
    ...
    class ToggleLikeTests {
        ...
        void toggleLike_NotLiked_AddsLike() {
            ...
            LikeResponse result = fuelReportLikeService.toggleLike(testFuelReport.getId(), "testuser");
    ...
    class GetLikeStatusTests {
        ...
        void getLikeStatus_UserLiked_ReturnsLikedTrue() {
            ...
            LikeResponse result = fuelReportLikeService.getLikeStatus(testFuelReport.getId(), "testuser");
            assertThat(result.isLiked()).isTrue();
